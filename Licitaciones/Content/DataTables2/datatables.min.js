...
f,d>e&&(d=0)):"Primero"==b?d=0:"Anterior"==b?(d=0<=f?d-f:0,0>d&&(d=0)):"Siguiente"==b?d+f<e&&(d+=f):"Ultimo"==b?d=Math.floor((e-1)/f)*f:aa(a,0,"Unknown paging action: "+b,5);b=a._iDisplayStart!==d;a._iDisplayStart=d;b&&(I(a,null,"page",[a]),c&&fa(a));return b}function Kb(a){return k("<div/>",{id:a.aanFeatures.r?null:a.sTableId+"_processing","class":a.oClasses.sProcessing}).html(a.oLanguage.sProcessing).insertBefore(a.nTable)[0]}function U(a,b){a.oFeatures.bProcessing&&k(a.aanFeatures.r).css("display",b?"block":
...
sScrollFoot:"dataTables_scrollFoot",sScrollFootInner:"dataTables_scrollFootInner",sHeaderTH:"",sFooterTH:"",sSortJUIAsc:"",sSortJUIDesc:"",sSortJUI:"",sSortJUIAscAllowed:"",sSortJUIDescAllowed:"",sSortJUIWrapper:"",sSortIcon:"",sJUIHeader:"",sJUIFooter:""});var ec=u.ext.pager;k.extend(ec,{simple:function(a,b){return["Anterior","Siguiente"]},full:function(a,b){return["Primero","Anterior","Siguiente","Ultimo"]},numbers:function(a,b){return[Ba(a,b)]},simple_numbers:function(a,b){return["Anterior",Ba(a,b),"Siguiente"]},
full_numbers:function(a,b){return["Primero","Anterior",Ba(a,b),"Siguiente","Ultimo"]},first_last_numbers:function(a,b){return["Primero",Ba(a,b),"Ultimo"]},_numbers:Ba,numbers_length:7});k.extend(!0,u.ext.renderer,{pageButton:{_:function(a,b,c,d,f,e){var g=a.oClasses,h=a.oLanguage.oPaginate,l=a.oLanguage.oAria.paginate||{},n,m,p=0,t=function(x,r){var A,E=g.sPageButtonDisabled,H=function(B){kb(a,B.data.action,!0)};var W=0;for(A=r.length;W<A;W++){var M=r[W];if(Array.isArray(M)){var C=k("<"+(M.DT_el||"div")+"/>").appendTo(x);
t(C,M)}else{n=null;m=M;C=a.iTabIndex;switch(M){case "ellipsis":x.append('<span class="ellipsis">&#x2026;</span>');break;case "Primero":n=h.sFirst;0===f&&(C=-1,m+=" "+E);break;case "Anterior":n=h.sPrevious;0===f&&(C=-1,m+=" "+E);break;case "Siguiente":n=h.sNext;if(0===e||f===e-1)C=-1,m+=" "+E;break;case "Ultimo":n=h.sLast;if(0===e||f===e-1)C=-1,m+=" "+E;break;default:n=a.fnFormatNumber(M+1),m=f===M?g.sPageButtonActive:""}null!==n&&(C=k("<a>",{"class":g.sPageButton+" "+m,"aria-controls":a.sTableId,"aria-label":l[M],
